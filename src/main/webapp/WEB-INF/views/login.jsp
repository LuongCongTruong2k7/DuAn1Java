    ...
    <div class="w-full max-w-[400px] bg-surface-container-lowest rounded-2xl shadow-lg p-8">
      ...
      <form method="post" action="${pageContext.request.contextPath}/login" class="space-y-4">
        <div>
          ...
          <input type="text" name="username" value="${rememberedUsername}" placeholder="Nhập tên đăng nhập" required class="w-full px-3 py-2.5 border border-border-light rounded-lg text-body-main font-body-main text-on-surface focus:outline-none focus:ring-2 focus:ring-primary-container/20 focus:border-primary-container bg-white">
        </div>
        <div>
          <label class="block text-label-md font-label-md text-text-secondary mb-1">Mật khẩu</label>
          <input type="password" name="password" value="${rememberedPassword}" placeholder="Nhập mật khẩu" required class="w-full px-3 py-2.5 border border-border-light rounded-lg text-body-main font-body-main text-on-surface focus:outline-none focus:ring-2 focus:ring-primary-container/20 focus:border-primary-container bg-white">
        </div>
