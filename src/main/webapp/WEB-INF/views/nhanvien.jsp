              ...
              <tr class="hover:bg-slate-50 transition-colors">
                ...
                <td class="px-4 py-3 text-right whitespace-nowrap">
                  <div class="inline-flex items-center gap-1.5 justify-end flex-wrap">
                    <a href="?edit=${u.userId}" class="inline-flex items-center gap-1.5 text-text-secondary rounded-lg px-2.5 py-1 text-[13px] font-body-main hover:bg-surface-container-low transition-colors">
                    ...
                    <c:if test="${u.isActive && u.userId != currentUser.userId}">
                      <form class="inline-form" method="post" action="${pageContext.request.contextPath}/admin/users"
                        ...
                        <input type="hidden" name="action" value="delete"><input type="hidden" name="id"
                          value="${u.userId}">
                        <button type="submit" class="p-1 text-secondary hover:text-danger transition-colors">
