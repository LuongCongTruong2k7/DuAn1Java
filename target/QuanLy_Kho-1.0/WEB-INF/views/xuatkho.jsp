    ...
    <c:choose>
      <c:when test="${not empty current}">
        ...
        <div class="flex items-center justify-between flex-wrap gap-3">
          <a href="${pageContext.request.contextPath}/admin/issues" class="inline-flex items-center gap-1.5 border border-border-light text-text-secondary rounded-lg px-3 py-2 text-[13px] font-body-main hover:bg-surface-container-low transition-colors">
        ...
        <div class="bg-white rounded-xl border border-border-light shadow-sm p-6">
          <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 text-body-main font-body-main">
            <p class="text-text-secondary"><span class="font-semibold text-on-surface">Người nhận:</span> ${current.recipient}</p>
        ...
        <div class="bg-white rounded-xl border border-border-light shadow-sm p-6 max-w-2xl">
          ...
          <form method="post" action="${pageContext.request.contextPath}/admin/issues">
            ...
            <div class="grid sm:grid-cols-2 gap-4">
              <div>
                <label class="block text-label-md font-label-md text-text-secondary mb-1">Người nhận</label>
                <input type="text" name="recipient" required class="w-full px-3 py-2 border border-border-light rounded-lg text-body-main font-body-main focus:outline-none focus:ring-2 focus:ring-primary-container/20 focus:border-primary-container bg-white">
              </div>
              <div>
            ...
            <div class="flex items-center gap-3 mt-5">
              <button type="submit" class="bg-primary-container text-white rounded-lg px-4 py-2 text-body-main font-body-main hover:bg-primary transition-colors">+ Tạo phiếu xuất</button>
            </div>
          </form>
        </div>
            ...
            <table class="w-full border-collapse">
              <thead>
                <tr class="bg-surface-bright border-b border-border-light">
                  ...
                  <th class="px-4 py-3 text-left text-table-head font-table-head text-text-secondary uppercase tracking-wider">Người nhận</th>
              ...
              <tbody class="divide-y divide-border-light text-body-main font-body-main align-middle">
                <c:forEach var="r" items="${issues}">
                  <tr class="hover:bg-slate-50 transition-colors">
                    <td class="px-4 py-3 text-text-secondary">#${r.issueId}</td>
                    ...
                    <td class="px-4 py-3 text-right whitespace-nowrap">
                      <a href="?view=${r.issueId}" class="inline-flex items-center gap-1.5 border border-border-light text-text-secondary rounded-lg px-2.5 py-1 text-[13px] font-body-main hover:bg-surface-container-low transition-colors">
